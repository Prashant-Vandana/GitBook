...
* **Notify Email**: This action notifies the end user who sent the Email with sensitive data, through email.
* **Notify Slack**: This action notifies the end user who sent the Email with sensitive data, through Slack.
