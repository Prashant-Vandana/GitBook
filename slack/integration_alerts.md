---
description: Learn the process of configuring alerts for Slack.
---
...
* [Slack](https://help.nightfall.ai/sensitive-data-protection/slack/configuring-integration-alerts#configuring-slack-as-an-alert-channel)&#x20;
* [Email](https://help.nightfall.ai/sensitive-data-protection/slack/configuring-integration-alerts#configuring-email-as-an-alert-channel)
* [Webhook](https://help.nightfall.ai/sensitive-data-protection/slack/configuring-integration-alerts#configuring-webhook-as-an-alert-channel)
* [Jira Tickets](https://help.nightfall.ai/sensitive-data-protection/slack/configuring-integration-alerts#configuring-jira-as-an-alert-channel)
...
### Configuring Slack as an Alert Destination
...
4. Select **No, only integration level** to use the Slack channel only for Slack DLP, or select **Yes, please** to use the selected Slack channel for all the Nightfall integrations.&#x20;
...
6. Select **No, only integration level** to use the configurations only for Slack DLP, or select **Yes, please** to use the selected JIRA configurations for all the Nightfall integrations.&#x20;
